...
from app.models import User, Project, Indicator, Complaint, Recommendation, RiskRegister, IPTTEntry, FieldVisit
...
def generate_infographic_data(
    ...
    return {
        ...
        "accountability": {
            ...
            "resolution_rate": round(sum(1 for c in complaints if c.status == "resolved") / len(complaints) * 100, 1) if complaints else 0,
        },
        "monitoring": {
