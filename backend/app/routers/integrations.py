...
from app.models import User, Project, Indicator, Beneficiary, Distribution, Complaint
...
def export_ocha_3w(
    ...
    for p in projects:
        ...
        ben_count = db.query(func.sum(Distribution.beneficiaries_count)).filter(
            Distribution.project_id == p.id
        ).scalar() or 0
