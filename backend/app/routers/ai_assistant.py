...
from app.models import (
    ...
    RiskRegister, LessonLearned, Distribution, IPTTEntry,
...
def generate_auto_report(
    ...
    risks = db.query(RiskRegister).filter(RiskRegister.project_id == project_id, RiskRegister.status != "resolved").all()
    risk_analysis = {
...
def detect_risks(
    ...
    if project.budget and project.spent:
        ...
        elif burn_rate < 30 and project.status == "active":
            detected_risks.append({
